...
const META = {
  corporate_mini:  { color: '#3b82f6', label: 'Corporate Mini',  price: 'KSH 15,000/mo' },
  corporate:       { color: '#3b82f6', label: 'Corporate',       price: 'KSH 30,000/mo' },
  major_corporate: { color: '#3b82f6', label: 'Major Corporate', price: 'KSH 100,000/mo' },
  enterprise:      { color: '#3b82f6', label: 'Enterprise',      price: 'KSH 250,000/mo' },
};
