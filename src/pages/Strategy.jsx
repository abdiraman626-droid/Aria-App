...
export default function Strategy() {
  ...
  const exportAsPdf = (strategy) => {
    ...
    w.document.write(`
      ...
      <style>body{font-family:system-ui,sans-serif;max-width:800px;margin:40px auto;padding:0 20px;line-height:1.8;color:#222}h1{color:#4F6EF7}h2,h3{margin-top:24px}pre{background:#f5f5f5;padding:16px;border-radius:8px;overflow-x:auto}</style>
      </head><body>
          ...
          {messages.length === 0 ? (
            <div style={{ padding: '32px 0' }}>
              <div style={{ textAlign: 'center', marginBottom: 32 }}>
                <div style={{ width: 64, height: 64, borderRadius: 18, background: 'rgba(79,110,247,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
